...
const products = [
    {id: uuidv4(), own: "суп", img: "sup1.jpeg", title: 'Джинсы', price: 5000, description: 'Синего цвета, прямые'},
    ...
    {id: uuidv4(), own: "лапша", img: "lapsha1.jpg", title: 'Ремень', price: 1322, description: 'Зеленого цвета, теплая'},
    {id: uuidv4(), own: "лапша", img: "lapsha2.jpg", title: 'Пряжка', price: 22, description: 'Зеленого цвета, теплая'},
    {id: uuidv4(), own: "лапша", img: "lapsha3.jpg", title: 'Джинсы 3', price: 5000, description: 'Синего цвета, прямые'},
    {id: uuidv4(), own: "лапша", img: "lapsha4.jpeg", title: 'Куртка 7', price: 600, description: 'Зеленого цвета, теплая'},
    {id: uuidv4(), own: "картошка", img: "potato1.jpg", title: 'Джинсы 4', price: 5500, description: 'Синего цвета, прямые'},
